...
# Site Data
    ...
    - `projects`
        - Yak Collective projects. See the [How to Add a New Project to the Website](<How to Add a New Project to the Website.md>) guide.
# Member Feeds
...
- You'll probably want to review the [Website Architecture](<Website Architecture.md>)

- [Website Architecture](<Website Architecture.md>)

## [December 11th, 2020](<December 11th, 2020.md>)
- Update the [Website Architecture](<Website Architecture.md>)

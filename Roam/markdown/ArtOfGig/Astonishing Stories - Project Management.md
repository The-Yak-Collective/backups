...
- Sprint workflow 
    ...
    - cover design call - draft - author review - ready for publishing with suggested changes/not ready for publishing without changes made - layout - proofread - publish
- {{mermaid}} 
    - graph LR
        - A[Author submits story]-->B[Editor picks up for review]--Changes needed before publishing/Suggested Changes-->C[Author review] --loop as needed-->B; C-->D[Commit to Layout picked up by infra team]-->E[Commit to proofread]-->F[publish]; E--loop as needed-->D
- {{mermaid}} Cover Design
    - graph LR
        - A[Author submits cover design call]-->B[Designer picks it up]-->C[[Author Review]]--Changes needed before publish/suggested changes-->B; C-->D[layout]-->E[publish];A--no designer-->F[author creates cover]-->D
